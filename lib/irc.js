                ...
                modeList.forEach(function(mode) {
                    ...
                    if (mode in self.prefixForMode) {
                        ...
                        if (adding) {
                            ...
                            self.emit('+mode', message.args[0], message.nick, mode, user, message, false);
                        }
                        else {
                        ...
                        if (adding) {
                            ...
                            self.emit('+mode', message.args[0], message.nick, mode, modeArg, message, true);
                        }
                        else {
